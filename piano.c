...
#define NOTE_A4  440
#define NOTE_B4  494
int note[7]={440, 494, 262, 294, 330, 349, 392};
...
void playMelody(int notes[], int durations[], int numNotes) {
  ...
  while(1) {
    ...
    index = nt - 'A';
    printf("%d\n",index);
    if(index>=0&&index<=7)	playNote(note[index],200);
    fflush(stdin);
    usleep(1000);
    

    /* pause between notes to avoid overlapping */
  }
}
...
int main(void) {
	...
	int durations[] = { 1000, 500, 1000, 500, 500, 500, 1000, 500, 500, 1000, 500, 500, 500 };
